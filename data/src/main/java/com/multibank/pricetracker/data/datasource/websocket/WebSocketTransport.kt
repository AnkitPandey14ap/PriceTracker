...
class WebSocketTransport @Inject constructor(
    ...
    val connectionState: StateFlow<ConnectionStateEntity> = _connectionState.asStateFlow()
    ...
    fun connect(url: String) {
        webSocket?.cancel()
        _connectionState.value = ConnectionStateEntity.Connecting
    ...
    private inner class TransportWebSocketListener : WebSocketListener() {
        ...
        override fun onOpen(ws: WebSocket, response: Response) {
            try {
                ...
                _connectionState.value = ConnectionStateEntity.Connected
            } catch (e: AppException) {
                Log.e(TAG, "WebSocket open interceptor error", e)
                _connectionState.value = ConnectionStateEntity.Disconnected
